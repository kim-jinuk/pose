...
def valid(datacfg, modelcfg, weightfile):
    ...
    if save:
        predfile = backupdir + '/predictions_nia_' + name + '.mat'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weightfile', type=str, default='data/sause_container13/model/model.weights') # imagenet initialized weights
