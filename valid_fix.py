    ...
    for batch_idx, (data, target) in enumerate(test_loader):
        ...
        for box_pr, target in zip([all_boxes], [target[0]]):
            ...
            for k in range(num_gts):
                ...
                corners2D_gt_first = np.array(np.reshape(box_gt[:18], [9, 2]), dtype='float32')

                corners2D_gt_second = np.array(np.reshape(box_gt[:18], [9, 2]), dtype='float32')
                corners2D_gt_second[1], corners2D_gt_second[2] = corners2D_gt_first[3], corners2D_gt_first[4]
                corners2D_gt_second[3], corners2D_gt_second[4] = corners2D_gt_first[7], corners2D_gt_first[8]
                corners2D_gt_second[5], corners2D_gt_second[6] = corners2D_gt_first[1], corners2D_gt_first[2]
                corners2D_gt_second[7], corners2D_gt_second[8] = corners2D_gt_first[5], corners2D_gt_first[6]

                corners2D_gt_third = np.array(np.reshape(box_gt[:18], [9, 2]), dtype='float32')
                corners2D_gt_third[1], corners2D_gt_third[2] = corners2D_gt_first[7], corners2D_gt_first[8]
                corners2D_gt_third[3], corners2D_gt_third[4] = corners2D_gt_first[5], corners2D_gt_first[6]
                corners2D_gt_third[5], corners2D_gt_third[6] = corners2D_gt_first[3], corners2D_gt_first[4]
                corners2D_gt_third[7], corners2D_gt_third[8] = corners2D_gt_first[1], corners2D_gt_first[2]

                corners2D_gt_fourth = np.array(np.reshape(box_gt[:18], [9, 2]), dtype='float32')
                corners2D_gt_fourth[1], corners2D_gt_fourth[2] = corners2D_gt_first[5], corners2D_gt_first[6]
                corners2D_gt_fourth[3], corners2D_gt_fourth[4] = corners2D_gt_first[1], corners2D_gt_first[2]
                corners2D_gt_fourth[5], corners2D_gt_fourth[6] = corners2D_gt_first[7], corners2D_gt_first[8]
                corners2D_gt_fourth[7], corners2D_gt_fourth[8] = corners2D_gt_first[3], corners2D_gt_first[4]
                ...
                fourth_error = 0
                for i in range(9):
                    first_error = first_error + ((corners2D_gt_first[i][0]*1280-corners2D_pr[i][0]*1280)**2)+((corners2D_gt_first[i][1]*720-corners2D_pr[i][1]*720)**2)
                    second_error = second_error + ((corners2D_gt_second[i][0]*1280-corners2D_pr[i][0]*1280)**2)+((corners2D_gt_second[i][1]*720-corners2D_pr[i][1]*720)**2)
                    third_error = third_error + ((corners2D_gt_third[i][0]*1280-corners2D_pr[i][0]*1280)**2)+((corners2D_gt_third[i][1]*720-corners2D_pr[i][1]*720)**2)
                    fourth_error = fourth_error + ((corners2D_gt_fourth[i][0]*1280-corners2D_pr[i][0]*1280)**2)+((corners2D_gt_fourth[i][1]*720-corners2D_pr[i][1]*720)**2)

                minimum_error = min(first_error,second_error,third_error,fourth_error)

                if minimum_error == second_error:
                    corners2D_gt = corners2D_gt_second
                elif minimum_error == third_error:
                    corners2D_gt = corners2D_gt_third
                elif minimum_error == fourth_error:
                    corners2D_gt = corners2D_gt_fourth
...
if __name__ == '__main__':
    ...
    parser.add_argument('--datacfg', type=str, default='data/sause_container4/sause_container4.data') # data config
    parser.add_argument('--modelcfg', type=str, default='cfg/yolo-pose.cfg') # network config
    parser.add_argument('--weightfile', type=str, default='data/sause_container4/model/model.weights') # imagenet initialized weights
